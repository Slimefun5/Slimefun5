...
public class MetricsService {
    ...
    private int getLatestVersion() {
        ...
        try {
            ...
            // A non-numeric tag (e.g. the semver "v1.0.0" release) is expected: the numeric build-number
            // scheme is legacy. Returning -1 makes the auto-updater fall back to the bundled module.
