...
public abstract class AbstractEntityAssembler<T extends Entity> extends SimpleSlimefunItem<BlockTicker> implements EnergyNetComponent {
    ...
    private void updateBlockInventory(BlockMenu menu, Block b) {
        if (!BlockStorage.hasBlockInfo(b) || BlockStorage.getLocationInfo(b.getLocation(), KEY_ENABLED) == null || BlockStorage.getLocationInfo(b.getLocation(), KEY_ENABLED).equals(String.valueOf(false))) {
            menu.replaceExistingItem(22, CustomItemStack.create(XMaterial.GUNPOWDER.parseMaterial(), "&7Enabled: &4\u2718", "", "&e> Click to enable this Machine"));
        ...
        menu.replaceExistingItem(31, CustomItemStack.create(XMaterial.PISTON.parseMaterial(), "&7Offset: &3" + offset + " Block(s)", "", "&fLeft Click: &7+0.1", "&fRight Click: &7-0.1"));
    ...
    protected void constructMenu(BlockMenuPreset preset) {
        ...
        preset.addItem(13, CustomItemStack.create(XMaterial.CLOCK.parseMaterial(), "&7Cooldown: &b30 Seconds", "", "&fThis Machine takes up to half a Minute to operate", "&fso give it some Time!"), ChestMenuUtils.getEmptyClickHandler());
    }
